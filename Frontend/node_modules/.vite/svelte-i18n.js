import {
  derived,
  writable
} from "./chunk-4KTB3SWY.js";
import "./chunk-TYTNWLLM.js";
import {
  __assign,
  __extends,
  __spreadArray
} from "./chunk-OFJ3T3AU.js";
import {
  __commonJS,
  __toESM
...
T.subscribe((e) => {
  L = null != e ? e : void 0, "undefined" != typeof window && null != e && document.documentElement.setAttribute("lang", e);
});
var M = Object.assign(Object.assign({}, T), { set: (e) => {
  if (e && function(e2) {
    ...
    let t2;
    return "undefined" != typeof window && null != D() && n ? t2 = window.setTimeout(() => k.set(true), n) : k.set(true), b(e).then(() => {
      T.set(e);
    }).finally(() => {
...
var N = (e) => "undefined" == typeof window ? null : S(window.location.hostname, e);
var A = (e) => "undefined" == typeof window ? null : S(window.location.pathname, e);
var I = () => "undefined" == typeof window ? null : window.navigator.language || window.navigator.languages[0];
var F = (e) => "undefined" == typeof window ? null : P(window.location.search.substr(1), e);
var z = (e) => "undefined" == typeof window ? null : P(window.location.hash.substr(1), e);
var Z = (e) => {
...
var J = Z((e) => {
  ...
  return t2 ? o = C("date", t2) : 0 === Object.keys(o).length && (o = C("date", "short")), new Intl.DateTimeFormat(n, o);
});
var U = Z((e) => {
  var { locale: n, format: t2 } = e, o = v(e, ["locale", "format"]);
  if (null == n)
    throw new Error('[svelte-i18n] A "locale" must be set to format time values');
  return t2 ? o = C("time", t2) : 0 === Object.keys(o).length && (o = C("time", "short")), new Intl.DateTimeFormat(n, o);
});
var _ = (e = {}) => {
...
var K = (e, n = {}) => {
  ...
  if (a2) {
    ...
    j().warnOnMissingMessages && console.warn(`[svelte-i18n] The message "${e}" was not found in "${E(r2).join('", "')}".${w(D()) ? "\n\nNote: there are at least one loader still registered to this locale that wasn't executed." : ""}`), a2 = null != i2 ? i2 : e;
  if (!o)
    return a2;
  let s2 = a2;
  try {
...
export {
  ...
  m as addMessages,
  ee as date,
  oe as defineMessages,
  s as dictionary,
  X as format,
  q as getDateFormatter,
  z as getLocaleFromHash,
  N as getLocaleFromHostname,
  I as getLocaleFromNavigator,
  A as getLocaleFromPathname,
  F as getLocaleFromQueryString,
