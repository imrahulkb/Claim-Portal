                  ...
                  <TabPane tabId={2} class={activeTab == 2 ? "active" : ""}>
                    ...
                    <div>
                                ...
                                <Row class="mb-3">
                                  ...
                                  <Col lg="2">
                                    ...
                                    >
                                      ...
                                      >
                                      <option
                                        value="Printing Stationery & Consumables"
                                  ...
                                  <Row>
                                    ...
                                    <Col lg="2" class="mb-3">
                                      <div
                                        ...
                                        on:click={() => getBase64(bill.receipt)}
                                      >
                                        {bill.receipt.name + " (View)"}
                                      </div>
                                    </Col>
                      ...
                      <div class="form-group mb-3">
                        ...
                        <Input type="number" bind:value={claimantDetails.event.total} disabled/>
                      </div>
                      <div class="form-group mb-3">
                      ...
                      <div class="form-group">
                        ...
                        <Input type="number" bind:value={claimantDetails.event.gross} disabled/>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div class="form-group mb-3">
                        <label>Net Amount</label>
                        <Input type="number" bind:value={receipt.amount} disabled/>
                      </div>
                      {#if receipt.amount >= 10000}
                        <div class="form-group mb-3">
                          <label>TDS @ 10%</label>
                          <Input type="number" value={receipt.amount * 0.1} disabled/>
                        </div>
                      {/if}
                      <div class="form-group">
                        <label>Gross Total</label>
                        <Input type="number" value={receipt.amount - (receipt.amount >= 10000 ? receipt.amount * 0.1 : 0)} disabled/>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <Row>
                        <Col lg="4" class="mb-3">
                          <Label>Number of Event reported via Vtools in previous year</Label>
                          <Input type="number"/>
                        </Col>
                        <Col lg="4" class="mb-3">
                          <Label>Description of Funds (SB Rebate/Project Funds)</Label>
                          <Input type="number"/> 
                        </Col>
                        <Col lg="4" class="mb-3">
