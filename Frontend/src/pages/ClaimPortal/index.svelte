...
let claimantDetails = {
  ...
  function getBase64(file) {
    ...
    reader.onload = function () {
      ...
      newTab.document.write(`<iframe width='100%' height='100%' src='${reader.result}'></iframe>`);
    };
  ...
  function handleAddFields() {
    let i = bills.length;
    bills[i] = receipt;
    bills[i]['id'] = idIncrement;
    bills[i]['receipt'] = files[0];
    receipt = {
      date: null,
      details: null,
      type: null,
              ...
              <div class="content clearfix">
                <TabContent class="twitter-bs-wizard-tab-content">
                  <TabPane tabId={1} id="personal-info" class={activeTab == 1 ? "active" : ""}>
                    ...
                    <Row>
                      <Col lg="4" class="mb-3">
                        <Label for="name">Expenses made for (Event Name)</Label>
                        <Input
                          type="text"
                          id="name"
                          name="untyped-input"
                      ...
                      <Col lg="4" class="mb-3">
                        <Label for="name">Type of Claim</Label>
                        <select
                            class="form-select"
                            id="subjectSelect"
                            ...
                            <option value="Award Of Honorium">Award Of Honorium</option>
                            <option value="Conference Deposit">Conference Deposit</option>
                            <option value="Student Branch Rebate">Student Branch Rebate</option>
                        </select>
                      </Col>
                    </Row>
                  </TabPane>
                  <TabPane tabId={2} id="confirm-email" class={activeTab == 2 ? "active" : ""}>
                          ...
                          <td>
                            <div>
                              <Row class="mb-3">
                                ...
                                <Col lg="3">
                                  <Label for="name">Bill Details</Label>
                                  <Input
                                    type="text"
                                    name="untyped-input"
                                    class="form-control"
                                ...
                                <Col lg="2">
                                  ...
                                  <select class="form-select" bind:value={receipt.type}>
                                      ...
                                      <option value="Printing Stationery & Consumables">Printing Stationery & Consumables</option>
                                      <option value="Miscellaneous Expenses">Miscellaneous Expenses</option>
                                  </select>
                                </Col>
                                <Col lg="2">
                                  <Label for="subject">Amount</Label>
                                  <Input type="number" class="form-control" bind:value={receipt.amount}/>
                                </Col>
                                <Col lg="2">
                                ...
                                <Col lg="1" class="align-self-center">
                                  <Button color="success" block on:click={handleAddFields}>
                                    Add
                                  </Button>
                                </Col>
                              </Row>
                            ...
                            <td>
                              <div>
                                <Row>
                                  ...
                                  <Col lg="2" class="mb-3">
                                    <Input type="text" class="form-control" value={bill.details} disabled/>
                                  </Col>

                                  <Col lg="2" class="mb-3">
                                    <Input type="text" class="form-control" value={bill.type} disabled/>
                                  </Col>

                                  <Col lg="2" class="mb-3">
                                    <Input type="text" class="form-control" value={bill.amount} disabled/>
                                  </Col>

                                  <Col lg="2" class="mb-3">
                                    <div class="form-control" style="height: 100%;background-color: var(--bs-gray-200);opacity: 1;cursor: pointer;color: var(--bs-blue);" on:click={()=>getBase64(bill.receipt)}>{bill.receipt.name + ' (View)'}</div>
                                  </Col>
 
                                  <Col lg="1" class="align-self-center">
                                    <div class="d-grid">
                                      <Button color="primary" style="width: 100%" block on:click={handleRemoveFields(bill.id)}>
                                        {" "}
                                        Delete
                                      </Button>
                                    </div>
                    ...
                    <div class="form-group mb-3">
                      ...
                      <input type="number" class="form-control" bind:value={claimantDetails.event.total} disabled/>
                    </div>
                    <div class="form-group mb-3">
                      <label>Less Advance Expense</label>
                      <input type="number" class="form-control" bind:value={claimantDetails.event.advance} on:input={calculate}/>
                    </div>
                    <div class="form-group">
                      <label>Gross Total</label>
                      <input type="number" class="form-control" bind:value={claimantDetails.event.gross} disabled />
                    </div>
                  </TabPane>
                  ...
                  <TabPane tabId={4} id="doc-verification" class={activeTab == 4 ? "active" : ""}>
                    <iframe src="{pdf}" style="width: 100%; height: 500px; margin: 0px; padding: 0px;" frameborder="0" framemargin="0"></iframe>
                  </TabPane>
                </TabContent>
              </div>
