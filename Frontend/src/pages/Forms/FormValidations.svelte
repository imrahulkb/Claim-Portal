  ...
  <Container fluid={true}>
    ...
    <Row>
      <Col xl="6">
        <Card>
          <CardBody>
            <h4 class="card-title">Svelte Validation - Normal</h4>
      ...
      <Col xl="6">
        <Card>
          <CardBody>
            <h4 class="card-title">Svelte Validation (Tooltips)</h4>
            <p class="card-title-desc">
    ...
    <Row>
      <Col lg={6}>
        <Card>
          <CardBody>
            <CardTitle class="h4">Validation type</CardTitle>
            <p class="card-title-desc">
              Parsley is a availity sveltestrap validation. It helps you provide
            ...
            <form class="custom-validation" action="#">
              ...
              <div class="mb-3">
                <label class="form-label" for="">Equal To</label>
                <div>
                  <input
                    type="password"
                    id="pass2"
              ...
              <div class="mb-3">
                <label class="form-label" for="">Digits</label>
                <div>
                  <input
              ...
              <div class="mb-3">
                <label class="form-label" for="">Alphanumeric</label>
                <div>
                  <input
      ...
      <Col lg={6}>
        <Card>
          <CardBody>
            <CardTitle class="h4">Range validation</CardTitle>
            <p class="card-title-desc">
              Parsley is a availity sveltestrap validation. It helps you provide
              your users with feedback on their form submission before sending
              it to your server.
