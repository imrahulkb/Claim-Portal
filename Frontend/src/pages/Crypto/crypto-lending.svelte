...
<div class="page-content">
  <Container fluid>
    <Breadcrumb title="Crypto" breadcrumbItem="Lending" />
      ...
      <Col xl="4">
        <Card>
          <CardBody class="border-bottom">
            ...
            >
              <DropdownToggle tag="a" color="" class="text-muted">
                  ...
                  <Row>
                    ...
                    <div class="col-lg-6 align-self-end">
                      <div class="float-end mt-3">
                        <Link to="#" class="btn btn-primary">Select</Link>
                      </div>
                    </div>
                  </Row>
                </div>
                  ...
                  {#each assets as asset}
                    <tr>
                      ...
                      <td style="width:120px">
                        <Link to="#" class="btn btn-primary btn-sm w-xs">
                          View
                        </Link>
                      </td>
                    </tr>
